...
public class _ChatStub extends org.omg.CORBA.portable.ObjectImpl implements ChatApp.Chat
{
  ...
  public String join (ChatApp.ChatCallback objref, String name)
  {
  ...
  public String post (ChatApp.ChatCallback objref, String msg)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return post (objref, msg        );
            } finally {
                _releaseReply ($in);
            }
  } // post

  public String leave (ChatApp.ChatCallback objref, boolean silent)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return leave (objref, silent        );
            } finally {
                _releaseReply ($in);
            }
  } // leave

  public String game (ChatApp.ChatCallback objref, String color)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public String move (ChatApp.ChatCallback objref, String msg)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
